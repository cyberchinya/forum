            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-list"></i>Forums</li>
                    </ol>
                </div>
            </div>
                                ...
                                @if (count($forums)> 0)
                                    @foreach ($forums as $forum)
                                        <tr>
                                            ...
                                            <td>{!!$forum->desc!!}</td>
                                            <td><a href="{{route('category',$forum->id)}}"><i class="fa fa-eye text-success"></i></a></td>
                                            <td><a href="{{route('category.update',$forum->id)}}"><i class="fa fa-edit text-info"></i></a></td>
                                            <td><a href="{{route('category.destroy',$forum->id)}}" class="text-danger"><i class="fa fa-trash"></i>Delete</a></td>
